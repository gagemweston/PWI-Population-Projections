...
cd "/Users/gageweston/Desktop/PWI/Population Projections/github"
...
sum year if tfr_scenario == "1.5"&population<2000000000&age=="all"
sum year if tfr_scenario == "1.2"&population<2000000000&age=="all"
sum year if tfr_scenario == "1.5"&population<1000000000&age=="all"
sum year if tfr_scenario == "1.2"&population<1000000000&age=="all"
...
(connected population year if year <= 2023, ms(i) lw(medthick) lc("191 87 0") lp(solid))
,
graphr(c(white) lc(white))
...
(connected births year if year <= 2023, ms(i) lw(medthick) lc("191 87 0") lp(solid))
,
graphr(c(white) lc(white))
